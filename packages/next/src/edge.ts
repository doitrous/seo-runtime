 ...
 * `@doitrous/seo-runtime-core/edge`, but importing `withSeoRedirects` from the package root
 ...
 * '@doitrous/seo-runtime-next'` fails to build for exactly that reason; importing from
 * `@doitrous/seo-runtime-next/edge` instead never reaches `index.ts` at all.
 */
